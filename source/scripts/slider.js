const sliderForm = document.querySelector('.slider__image-box');

if (sliderForm) {
  const sliderButton = document.querySelector('.slider__line');
  ...
  sliderButton.onmousedown = function(e) {
    ...
    function onMouseMove(event) {
      ...
      const rightEdge = sliderForm.offsetWidth - sliderButton.offsetWidth;
